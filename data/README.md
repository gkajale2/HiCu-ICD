Our data preprocessing follows [HiCu-ICD](https://github.com/wren93/HiCu-ICD) with slight modifications. To set up the dataset, follow the instructions below:
